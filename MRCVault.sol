...
contract MRCVault is Ownable, Pausable {
     ...
     */
    function deposit(uint256 _amount) external whenNotPaused { //We take away the notContract so the other contract can deposit, but leave it on the other functions.
    ...
    function harvest() external notContract whenNotPaused {
        ...
        _earn(); //if there's any additional that needs to go in, we put it back in.
